                ...
                <article>
                    ...
                    <article>
                        ...
                        <section>
							...
							<p>また、<a href="https://help.qiita.com/ja/articles/qiita-community-guideline">Qiita のコミュニティガイドライン</a>に従ってください。</p>
                        </section>
                    </article>
					<article>
						<h2 className="text-2xl my-2">これまでのアドベントカレンダー</h2>
						<section>
							<p>
								これまでに、開催したアドベントカレンダーは以下に掲載します。
							</p>
							<ul className="ml-8 list-disc">
								<li><p><a href="https://qiita.com/advent-calendar/2024/oecu">2024年</a></p></li>
							</ul>
						</section>
					</article>
                </article>
